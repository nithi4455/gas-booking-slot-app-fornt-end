      ...
      >
        <div className="navbar ">
          <div className="navbar-start">
            ...
            </div> <img src="./public/vite.svg" alt="Logo" className="h-8 w-8 mr-2" />
          ...
          <div className="navbar-end space-x-3">
            ...
            <div className="">
              <a className="bg-black text-white px-3 py-3 rounded-md hover:bg-slate-800 duration-300 cursor-pointer">Login</a>
            </div>
          </div>
        </div>
      </div>
